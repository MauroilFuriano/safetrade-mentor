...
const TUTORIALS: Tutorial[] = [
  {
    ...
    duration: "2:15",
    description: "Impara a navigare nella dashboard Futures di MEXC. Scopri dove trovare il grafico, il saldo del portafoglio e il pannello di controllo.",
    icon: <Layout size={24} />,
    color: "bg-blue-500"
  },
  {
    ...
    duration: "1:45",
    description: "Fondamentale: Leva alta = Liquidazione rapida. Impara a impostare 'Isolated' e Leva max 5x per evitare che una piccola oscillazione (5%) bruci il tuo capitale.",
  ...
  },
  {
    ...
    duration: "3:00",
    description: "Capire la liquidità: come leggere gli ordini di acquisto (verdi) e vendita (rossi) per decidere il miglior prezzo di entrata.",
    icon: <List size={24} />,
    color: "bg-amber-500"
  },
  {
    ...
    duration: "2:30",
    description: "Guida pratica all'apertura di un trade: impostazione del prezzo, quantità e inserimento contestuale di Stop Loss e Take Profit.",
        ...
        <div className="bg-slate-800 px-6 py-4 flex justify-between items-center border-b border-slate-700 flex-none">
          <div className="flex items-center gap-3">
             ...
             <h3 className="text-white font-bold text-lg flex items-center gap-2">
               {activeVideo ? activeVideo.title : 'Tutorial Piattaforma MEXC'}
             </h3>
          </div>
                    ...
                    <div className="w-full aspect-video bg-black rounded-xl border border-slate-800 relative group overflow-hidden flex items-center justify-center shadow-lg">
                        ...
                        <div className="absolute inset-0 bg-slate-900 flex flex-col items-center justify-center">
                             <div className={`p-6 rounded-full ${activeVideo.color} bg-opacity-20 mb-4 animate-pulse`}>
                                {React.cloneElement(activeVideo.icon as React.ReactElement, { size: 48, className: "text-white opacity-80" })}
                             </div>
